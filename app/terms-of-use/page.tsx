      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className=" mx-auto">
            ...
            {/* Section 1 */}
            <h2 className="text-navy font-gilroy-bold text-3xl mt-12 mb-6">1. Overview and Agreement</h2>
            <p className="mb-4 font-gilroy-regular">
            ...
            <ul className="list-disc pl-6 mb-6 font-gilroy-regular">
            ...
            <p className="mb-8 font-gilroy-regular">
            ...
            {/* Section 2 */}
            <h2 className="text-navy font-gilroy-bold text-3xl mt-12 mb-6">2. Eligibility and Program Participation</h2>
            <p className="mb-6 font-gilroy-regular">
            ...
            <h3 className="text-navy font-gilroy-bold text-2xl mt-8 mb-4">Quest Requirement for Frat Villa</h3>
            <p className="mb-8 font-gilroy-regular">
            ...
            {/* Section 3 */}
            <h2 className="text-navy font-gilroy-bold text-3xl mt-12 mb-6">3. Use and Purpose of Website</h2>
            <p className="mb-4 font-gilroy-regular">The Website is provided to:</p>
            <ul className="list-disc pl-6 mb-6 font-gilroy-regular">
            ...
            <ol className="list-decimal pl-6 mb-6 font-gilroy-regular">
            ...
            {/* Section 4 */}
            <h2 className="text-navy font-gilroy-bold text-3xl mt-12 mb-6">4. Intellectual Property</h2>
            <p className="mb-4 font-gilroy-regular">
            ...
            {/* Section 5 */}
            <h2 className="text-navy font-gilroy-bold text-3xl mt-12 mb-6">5. Data and Privacy</h2>
            <p className="mb-6 font-gilroy-regular">
            ...
            <p className="mb-4 font-gilroy-regular">We retain and process personal data solely to:</p>
            <ul className="list-disc pl-6 mb-6 font-gilroy-regular">
            ...
            {/* Section 6 */}
            <h2 className="text-navy font-gilroy-bold text-3xl mt-12 mb-6">6. Limitation of Liability</h2>
            <p className="mb-4 font-gilroy-regular">Fraterny is not liable for:</p>
            <ul className="list-disc pl-6 mb-6 font-gilroy-regular">
            ...
            {/* Section 7 */}
            <h2 className="text-navy font-gilroy-bold text-3xl mt-12 mb-6">7. User Conduct and Suspension</h2>
            <p className="mb-4 font-gilroy-regular">Fraterny reserves the right to terminate or suspend access if a user:</p>
            <ul className="list-disc pl-6 mb-6 font-gilroy-regular">
            ...
            {/* Section 8 */}
            <h2 className="text-navy font-gilroy-bold text-3xl mt-12 mb-6">8. Program Fees and Payments</h2>
            <p className="mb-4 font-gilroy-regular">By enrolling in any paid service (Quest Premium or Frat Villa), you agree to:</p>
            <ul className="list-disc pl-6 mb-6 font-gilroy-regular">
            ...
            {/* Section 9 */}
            <h2 className="text-navy font-gilroy-bold text-3xl mt-12 mb-6">9. Disclaimers</h2>
            <ul className="list-disc pl-6 mb-6 font-gilroy-regular">
            ...
            {/* Section 10 */}
            <h2 className="text-navy font-gilroy-bold text-3xl mt-12 mb-6">10. Dispute Resolution and Governing Law</h2>
            <p className="mb-6 font-gilroy-regular">
            ...
            {/* Section 11 */}
            <h2 className="text-navy font-gilroy-bold text-3xl mt-12 mb-6">11. Changes and Amendments</h2>
            <p className="mb-12 font-gilroy-regular">
            ...
            <p className="text-sm text-gray-500 mt-12 italic border-t pt-6 font-gilroy-regular">
