          ...
          {[...testimonials, ...testimonials].map((testimonial, index) => {
            ...
            return (
              <div
                ...
                className={`w-full mr-4 h-auto pb-8 relative ${colorClasses.bg} rounded-xl border-2 overflow-hidden flex-shrink-0`}
              >
                <p className={`pl-5 pt-2 text-7xl font-normal font-gilroy-medium`}>"</p>
                ...
                <div className=' flex justify-between pl-5 pr-1 pt-2'>
                  <div className='pr-4 pt-5'>
                    <div className={`${colorClasses.text} justify-end items-end text-5xl font-normal font-gilroy-semibold tracking-[-3px]`}>
                      {testimonial.tag}
                    </div>
                    <div className="flex justify-start text-neutral-200 text-sm font-normal font-gilroy-regular">
                      posted anonymously
                    </div>
                  </div>
                </div>
