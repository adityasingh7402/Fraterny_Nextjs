...
const DepthSection = () => {
  ...
  const midPoint = Math.ceil(depthFeatures.length / 2);
  const topRow = [...depthFeatures.slice(0, midPoint), ...depthFeatures.slice(0, midPoint), ...depthFeatures.slice(0, midPoint)];
    ...
    <section className="py-12 md:py-20 px-4 bg-white overflow-hidden 
      ...
      {/* <div className="max-w-7xl mx-auto mb-8 md:mb-16">
        <h2 className="text-2xl md:text-4xl lg:text-5xl font-gilroy-bold text-center mb-3 md:mb-4 leading-tight">
          Designed for <span className="text-neutral-500">Depth</span>
        </h2>
        <p className="text-center text-gray-500 text-sm md:text-base mb-8 md:mb-12 font-gilroy-semibold">
          A comprehensive experience built on psychology and practice
        </p>
      </div> */}
      ...
      <div className="mb-4 md:mb-8">
        ...
        >
          {topRow.map((feature, index) => (
            <div
              key={index}
              className="bg-white p-4 md:p-6 rounded-lg md:rounded-xl shadow-lg border border-cyan-700/20 w-[320px] md:w-[380px] flex-shrink-0"
            >
              {/* Icon */}
              <div className="bg-black p-3 md:p-4 rounded-full w-fit mb-3 md:mb-4">
              ...
              {/* Title */}
              <h3 className="text-base md:text-lg lg:text-xl font-gilroy-bold text-neutral-700 mb-2 md:mb-3">
                {feature.title}
              </h3>

              {/* Description */}
              <p className="text-gray-700 text-xs md:text-sm leading-relaxed font-gilroy-regular min-h-[60px] md:min-h-[80px]">
                {feature.description}
              </p>
            </div>
          ))}
