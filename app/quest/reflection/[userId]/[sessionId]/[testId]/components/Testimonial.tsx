          ...
          {[...testimonials, ...testimonials].map((testimonial, index) => {
            ...
            return (
              <div
                ...
                className={`w-full mr-4 h-auto pb-8 relative bg-transparent rounded-xl border-2 overflow-hidden flex-shrink-0`}
              >
                ...
                <div className=' flex justify-between pl-5 pr-1 pt-2'>
                  <div className='pr-4 pt-5'>
                    <div className={`text-neutral-100 justify-end items-end text-5xl font-normal font-gilroy-semibold tracking-[-3px]`}>
                      {testimonial.tag}
                    </div>
