...
const FAQIntrospection: React.FC<FaqSectionProps> = ({ 
  className = '' 
}) => {
  ...
  return (
    <section 
      className={`w-full min-h-screen px-6 py-12 bg-white ${className}`}
    >
      ...
      <div className="space-y-0">
        {faqs.map((faq, index) => (
          <div key={index} className="border-b border-white/20">
            ...
            >
              <h3 
                className="text-neutral-800 pr-4 font-gilroy-regular text-[28px] font-weight-400"
              ...
              >
                {openIndex === index ? (
                  <X size={24} className="text-black rotate-45" />
                ) : (
              ...
              {openIndex === index && (
                ...
                >
                  <div className="pb-6 pr-12">
                    <p 
                      className="text-neutral-600 whitespace-pre-line font-gilroy-regular"
                      style={{
                        fontWeight: 400,
                        fontSize: '20px',
                        lineHeight: '130%',
...
export default FAQIntrospection;
