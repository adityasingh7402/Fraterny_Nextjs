      ...
      */}
      ...
      >
        ...
        <motion.div
          ...
          className={`mt-1 text-[20px] xs:text-xl font-gilroy-light px-4 py-2 rounded-[35px] ${data.buttonbg} text-white`}
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                className={`mt-1 text-md xs:text-xl font-gilroy-regular px-5 xs:px-8 py-2 rounded-[35px] ${data.buttonbg} text-white`}
                style={data.color ? { backgroundColor: data.color } : undefined}
              >
                {data.subtitle}
              </motion.div>
