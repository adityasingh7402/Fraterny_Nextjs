  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        {/* Success Card */}
        <div
          className={`flex flex-col gap-2 rounded-xl p-6 border border-gray-200 bg-white cursor-pointer hover:shadow-lg transition-shadow ${activeStatus === 'success' ? 'ring-2 ring-green-500 bg-green-50' : ''
            }`}
        ...
        {/* Attempted Card */}
        <div
          className={`flex flex-col gap-2 rounded-xl p-6 border border-gray-200 bg-white cursor-pointer hover:shadow-lg transition-shadow ${activeStatus === 'Start' ? 'ring-2 ring-orange-500 bg-orange-50' : ''
            }`}
        ...
        {/* Disputed Card */}
        <div
          className={`flex flex-col gap-2 rounded-xl p-6 border border-gray-200 bg-white cursor-pointer hover:shadow-lg transition-shadow ${activeStatus === 'error' ? 'ring-2 ring-red-500 bg-red-50' : ''
            }`}
