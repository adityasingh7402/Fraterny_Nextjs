...
const SectionCard = ({
    ...
    return (
        <div className="bg-white shadow rounded-lg overflow-hidden hover:shadow-md transition-shadow flex flex-col h-full">
            {/* Header */}
            ...
            <div className="p-4 flex-1 flex flex-col">
                ...
                <button
                    ...
                    className="w-full px-3 py-2 bg-navy text-white rounded-md hover:bg-navy/90 transition-colors font-medium text-sm mt-auto"
                >
                    Manage Images
                </button>
            </div >
